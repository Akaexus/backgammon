...
class TournamentScoreListAdapter(private val context: Context, private val arrayList: MutableList<List<*>>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        player.text = arrayList[position][0] as CharSequence?
        points.text = arrayList[position][1].toString()
        return convertView
    }
}